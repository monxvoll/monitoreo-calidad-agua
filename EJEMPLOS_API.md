...
curl -X POST http://localhost:8080/api/muestras \
  ...
  -d '{
    "idSensor": 1,
    "fechaMuestra": "2025-09-15T16:00:00",
    "mediciones": [
      {"idParametro": 1, "valor": 26.0},
      {"idParametro": 2, "valor": 7.3}
    ]
  }'
...
curl http://localhost:8080/api/reportes/promedio-ph
```
...
1. Asegúrate de que los IDs de sensor y parámetro existan antes de usarlos en los endpoints de muestras
2. El formato de fecha debe ser ISO 8601: `YYYY-MM-DDTHH:mm:ss`
3. Todos los endpoints retornan JSON
4. Los códigos de respuesta HTTP son estándar:
